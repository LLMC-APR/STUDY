...
source_length=512
target_length=128
output_dir=/dataset/Tufano_dataset/datasets/result_GraphCodeBERT/50-100/mark2_src/model_set1
input_dir=/dataset/Tufano_dataset/datasets/preprocess/50-100/mark2_src
