...
lr=5e-5
batch_size=1 # don't change this value, because this is a set 2
beam_size=100
...
output_dir=/SS970evo/datasets/CPatMiner_dataset/result_CodeT5/mark2/model_set1
input_dir=/SS970evo/datasets/Defects4J_dataset/mark2_D4j_short_v2
# output_dir=$model_dir/D4J_V1
