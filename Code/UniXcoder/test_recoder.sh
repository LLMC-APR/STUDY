...
source_length=512
target_length=256
model_dir=/dataset/Recoder_dataset/result_UniXcoder/mark2/model_set1
input_dir=/dataset/Defects4J_dataset/mark2_D4j_v1
output_dir=$model_dir/D4j_V1_bleu
dev_file=None
test_file=$input_dir/note-src-test.txt,$input_dir/note-tgt-test.txt
