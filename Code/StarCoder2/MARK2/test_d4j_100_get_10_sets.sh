...
output_dir=/Data/Transfer_dataset/Result/1_LLM4APR/result_StarCoder2-15B/model_set_mark2_2048_LORA/D4J/temperature/beam_size_$beam_size
model_dir=/Data/Transfer_dataset/Result/1_LLM4APR/result_StarCoder2-15B/model_set_mark2_2048_LORA

mkdir -p $output_dir

python test_d4j_100_get_10_sets.py \
