...
def model_inference():
    ...
    tokenizer = AutoTokenizer.from_pretrained('bigcode/starcoder2-15b', use_auth_token=True)
    ...
    with open(src_filename, 'r') as f1,open(trg_filename, 'r') as f2:
        ...
        for line1,line2 in zip(f1,f2):
            ...
            if input_ids.size(1) >= 1500:
                ...
                args.output_size = 50
                # continue
            elif input_ids.size(1) >=464 and input_ids.size(1) < 549:
                args.beam_size = 60
                args.output_size = 60
                # continue
            elif input_ids.size(1) >=400 and input_ids.size(1) < 464:
                args.beam_size = 70
                args.output_size = 70
                # continue
